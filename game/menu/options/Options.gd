...
func _ready():
	...
	menuAnimation.init([$LblTitle, $BtnBack, $"VBoxContainer/OptionsGPGS/BtnConnect",
		$"VBoxContainer/OptionsGPGS/BtnRanking", $"VBoxContainer/OptionsGPGS/BtnAchievements",
		$"VBoxContainer/OptionsSocial/BtnShare", $"VBoxContainer/OptionsSocial/BtnSFX",
		$"VBoxContainer/OptionsSocial/BtnMusic"], .2)
